...
void testApp::loadSettings(){//load settings from XML files
...
/*void testApp::drawGrid(int dimSquare){//draw grid with cell dimension == "dimSquare"
    ...
    for(int grY=0; grY<=800; grY+=dimSquare){
            for(int grX=0; grX<=1280; grX+=dimSquare){
                ofRect(grX,grY,dimSquare,dimSquare);
            }
        }
